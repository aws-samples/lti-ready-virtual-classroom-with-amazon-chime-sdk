...
const MeetingJoinDetails = () => {
  ...
  // const { meetingId, localUserName, participantInfo } = useAppState();
  const { meetingId, participantInfo } = useAppState();
    ...
    <>
      <Flex container alignItems="center" flexDirection="column">
        ...
        <Label style={{ margin: '.75rem 0 0 0' }}>
          Joining meeting <b>{meetingId}</b> as <b>{participantInfo.ParticipantID}</b>
        </Label>
      </Flex>
      {error && (
